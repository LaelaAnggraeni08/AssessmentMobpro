...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener { hitungRataRata() }
    }

    private fun hitungRataRata() {
        ...
        val average = (nilaiSatu.toFloat() + nilaiDua.toFloat() + nilaiTiga.toFloat()) / 3

        binding.hasilTextView.text = getString(R.string.hasil, average)
    }
}